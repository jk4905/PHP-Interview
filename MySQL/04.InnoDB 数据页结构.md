...
![数据页结构示意图](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713773823171.jpg)
...
![过程示意图](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713773973403.jpg)
...
![示意图](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713774530187.jpg)
...
我们简化一下图：
![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713774690460.jpg)
...
![示意图](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713774800374.jpg)


插入了 4 条记录，但是在 InnoDB 中还自动定义了两个记录分别为最小记录和最大纪录。

![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713774931263.jpg)


这两个记录不会放在「页」的 User Records 中，而是单独放在 Infimum + Supremum。

![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713775048821.jpg)


在 next_record 中，记录了从当前记录的真实数据到下一个记录的真实数据的地址偏移量。每一行数据串联成一个链表，可以通过一个记录早到它的下一条记录，而且这几个记录是按照主键值由小到大顺序排列。

![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713775154082.jpg)
...
![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713775289578.jpg)
...
![示意图](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713775435343.jpg)
...
![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713775863971.jpg)
...
![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713776048849.jpg)
...
![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713776150161.jpg)
...
3. FIL_PAGE_PREV 和 FIL_PAGE_NEXT，表示页的上一个和下一个页号，让页之间变成双向链表。
   ![1](http://pzjwh5v7g.bkt.clouddn.com/mweb/15713776352810.jpg)
